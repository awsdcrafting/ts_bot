...
public class Abfuck extends Command
{
	...
	{
		api.sendPrivateMessage(e.getInvokerId(), "Starting to getting on everyones nerves :D");
		...
		for (Client client : api.getClients())
		{
			...
			if(client.isInServerGroup(23167)){
				...
				api.pokeClient(client.getId(), "[B]Was fällt dir ein? Du bist kein stellvertreter [COLOR=#aa0000]SCHÄM DICH![/COLOR][/B]");
