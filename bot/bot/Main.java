...
public class Main {
 ...
 public static void	main(String[] args){
        ...
        if (e.getTargetMode() != TextMessageTargetMode.SERVER && e.getInvokerId() != botID) {
				...
				if(message.equals("!votestart")){api.sendPrivateMessage(e.getInvokerId(),"Command: !votestart name m�glichkeit1 m�glichkeit2 m�glichkeit3 m�glichkeit4");}
				else{
				if(message.startsWith("!votestart")){
					...
					vote_m4 = subString[5];
					api.sendServerMessage("votet mit !vote (votem�glichkeit) f�r: " + vote + "  " + vote_m1 + "  "  + vote_m2 + "  "  + vote_m3 + "  "  + vote_m4);
					api.sendServerMessage("antwortet im private chat (rechtsklick auf den bot und dann: text chat �ffnen)");
					}
					}
